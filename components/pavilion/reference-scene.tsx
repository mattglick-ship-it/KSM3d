...
const [sofaOffset, setSofaOffset] = useBakedValue<{ x: number; z: number }>("pav.sofaOffset", { x: 0, z: 0 });
const [sofaRotationDeg, setSofaRotationDeg] = useBakedValue<number>("pav.sofaRotDeg", 0);
const [tableOffset, setTableOffset] = useBakedValue<{ x: number; z: number }>("pav.tableOffset", { x: 0, z: 0 });
const [tableRotationDeg, setTableRotationDeg] = useBakedValue<number>("pav.tableRotDeg", 0);
const [eggOffset, setEggOffset] = useBakedValue<{ x: number; z: number }>("pav.eggOffset", { x: 0, z: 0 });
const [eggRotationDeg, setEggRotationDeg] = useBakedValue<number>("pav.eggRotDeg", 0);
const [tvCorner, setTvCorner] = useBakedValue<"fl" | "fr" | "br" | "bl">("pav.tvCorner", "fl");
const [tvHeightFt, setTvHeightFt] = useBakedValue<number>("pav.tvHeightFt", 6);
const [diningOffset, setDiningOffset] = useBakedValue<{ x: number; z: number }>("pav.diningOffset", { x: 0, z: 0 });
const [diningRotationDeg, setDiningRotationDeg] = useBakedValue<number>("pav.diningRotDeg", 0);
const [patioOffset, setPatioOffset] = useBakedValue<{ x: number; z: number }>("pav.patioOffset", { x: 0, z: 0 });
const [patioRotationDeg, setPatioRotationDeg] = useBakedValue<number>("pav.patioRotDeg", 0);
